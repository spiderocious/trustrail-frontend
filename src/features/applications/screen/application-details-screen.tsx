  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {/* Hero Section */}
        <div className="bg-gradient-to-r bg-blue-600 text-white p-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center gap-3">
                <div
                  className={`px-4 py-2 rounded-full ${statusConfig.bg} flex items-center gap-2`}
                >
                  <statusConfig.icon
                    className={`text-lg ${statusConfig.color}`}
                  />
        ...
        <div className="max-w-7xl mx-auto p-8 space-y-6">
          {/* Trust Score Card */}
          <div
            className={`rounded-xl p-8 ${gradeConfig.bg} border-l-4 ${gradeConfig.color.replace("text-", "border-")}`}
          >
              ...
              <div className="flex items-center gap-8">
                <div className="relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <div
                        className={`text-4xl font-bold ${gradeConfig.color}`}
                      >
                        {trustScore}
                      </div>
                ...
                <div>
                  <div
                    className={`text-2xl font-bold ${gradeConfig.color} mb-1`}
                  >
