          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-8 py-4 sm:py-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-white rounded-lg p-4 sm:p-6 shadow-sm">
                ...
                {/* Live Breakdown */}
                <div className="border-2 border-dashed border-blue-200 rounded-lg p-3 sm:p-4 bg-blue-50">
                  <div className="text-xs sm:text-sm font-semibold text-blue-900 mb-2 sm:mb-3">
                    LIVE BREAKDOWN
                  </div>
              ...
              <div className="bg-white rounded-lg p-4 sm:p-6 shadow-sm">
                ...
                <div className="relative h-6 sm:h-8 bg-gradient-to-r from-red-500 via-yellow-500 via-blue-500 to-green-500 rounded-lg mb-6 hidden sm:block">
                  <div
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4 sm:mt-12">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Auto-Decline (Score ≤)
                    </label>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <button
                  ...
                  className="flex-1 px-4 sm:px-6 py-3 border border-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-50 transition-colors order-2 sm:order-1"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 px-4 sm:px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed order-1 sm:order-2"
                >
