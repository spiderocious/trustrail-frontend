      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto">
          <div className="max-w-7xl mx-auto px-4 sm:px-8 py-4 sm:py-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-6 sm:mb-8">
              <div>
                <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-1 sm:mb-2">
                  ...
                  <span
                    className={`px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-xs sm:text-sm font-medium ${wallet.isActive ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-700"}`}
                  >
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-6 sm:mb-8">
              <div className="bg-white rounded-lg p-4 sm:p-6 shadow-sm">
                <div className="flex items-center justify-between mb-2 sm:mb-4">
                  <div className="text-[10px] sm:text-sm font-semibold text-gray-500">
                    TOTAL APPLICATIONS
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
              ...
              <div className="bg-white rounded-lg p-4 sm:p-6 shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4">
                  <div>
                    <div className="text-[10px] sm:text-xs font-semibold text-gray-500 mb-0.5 sm:mb-1">
                      TOTAL AMOUNT
                    </div>
            ...
            {/* Collected Funds */}
            {analytics && (
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-4 sm:p-8 mb-6 sm:mb-8">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div>
                    <div className="text-xs sm:text-sm font-semibold text-green-700 mb-1 sm:mb-2">
                      Collected Funds
                    </div>
            ...
            <div className="text-center">
              <Link
                ...
                className="inline-block w-full sm:w-auto px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors text-sm sm:text-base"
              >
